Vue.component('trainer-trainings', {
			...
			<div class="tab-panel about-wrapper">
			     <ul class="nav nav-pills me-3" id="pills-tab" role="tablist">
	       		...
	       		<div class="tab-content" id="pills-tabContent" style="margin-top: 1em">
	       			<div class="tab-pane fade show active" id="pills-trainings" role="tabpanel" aria-labelledby="pills-home-tab">	  
	       			...
	       			<div class="tab-pane fade" id="pills-scheduled-trainings" role="tabpanel" aria-labelledby="pills-home-tab">	  
	            		<div class="center-container">
	                            <div class="buttons-galore" style="max-width: 100%; padding: 2em; margin: 0" >
	                                <div class="filter-and-sort">
	                                    <div class="dropdown">
						...
						<div class="users-table">
	        				<table class="table table-borderless">
	                    		...
	                    		<tbody>
				                    <tr v-for="training in this.scheduledTrainings">
					                    <td>
					                    <span class="text-muted">{{ training.Training.Name }}</span><br>
					                    </td>
					                    <td>
				                    	...
				                    	<td>
					                    <span class="search-button" type="button" v-if="training.Training.TrainingType === 'Personalni'">Otkaži</span><br>
				                    	</td>
				                    </tr>
	                    		</tbody>
	                    	</table>
	...
	methods: {
        ...
        getTrainingsForTrainer: function(id) {
			axios.get(`/rest/trainers/${id}/trainings`)
                .then(response => {
